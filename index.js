...
*/
const XPTN = '_calyza'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://www.instagram.com/_calyza/'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/+6285601459079'; // JANGAN DI UBAH NANTI EROR
const aktif = 'Sesuai Selera'; // DI GANTI AUTO EROR
const groupwa = 'BELUM PUNYA GRUB'; // DI GANTI AUTO EROR
const youtube = 'BELUM PUNYA GRUB'; // DI GANTI AUTO EROR
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] _calyza Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @_calyza`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @_calyza`)
})
...
conn.sendMessage(id, 'Waalaikumsalam, Aku Botnya _calyza Ketik #help/#info Contoh #help' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, Aku Botnya _calyza Ketik #help/#info Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, Aku Botnya _calyza Ketik #help/#info Contoh #help' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, Aku Botnya _calyza Ketik #help/#info Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Nih Owner Gwa _calyza, dia orangnya baek, pinter ganteng lagi chat aja orangnya 👉🏻  wa.me/+6285601459079' ,MessageType.text);
}
else if (text == 'Keza'){
conn.sendMessage(id, 'Iya Apa?' ,MessageType.text);
}
else if (text == 'Kepo'){
conn.sendMessage(id, 'Ya Udah Terserah' ,MessageType.text);
}
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6285601459079* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Aku Botnya _calyza Ketik .help/.info Contoh #help' ,MessageType.text);
}
...
else if (text == '.temenowner'){
conn.sendMessage(id, 'Ga Ada Temen!!!' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'Ga Punya Co!!!' ,MessageType.text);
}
else if (text == '.groupbot'){
conn.sendMessage(id, 'Ga Punya Grupp!!' ,MessageType.text);
}
else if (text == '.tools1'){
  ...
  var teks = text.replace(/.nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[ ❗ ] Tunggu Lagi Di Proses...!!', MessageType.text)
...
conn.sendMessage(id, ' _TERIMAKASIH BANYAK TELAH MENGGUNAKAN FITUR INI...JANGA LUPA SUBSCRIBE CHANNEL GAMER LEGENDS YHA' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *_calyza* , Follow Instagram Mimin Yah😻 : https://www.instagram.com/_calyza/' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *_calyza* , Follow Instagram Mimin Yah😻 : https://www.instagram.com/_calyza/' ,MessageType.text);
}
...
if (text.includes(".ytmp4"))
   {
      ...
      {
         conn.sendMessage(id, "maaf, link yang kamu kirim tidak valid :(", MessageType.text)
      }
      ytdl.getInfo(videoid[1]).then(info =>
      {
         if (info.length_seconds > 1000)
         {
            conn.sendMessage(id, "maaf durasi videonya kepanjangan :(", MessageType.text)
         }
         else
         {
...
//Tolonglah bro jangan di ubah ubah by KezaWaBot
